...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(204,153,255),
    accentcolor2 = Color3.fromRGB(63,91,156),
    outlinecolor = Color3.fromRGB(60, 60, 60),
    outlinecolor2 = Color3.fromRGB(20, 20, 20),
    sectorcolor = Color3.fromRGB(30, 30, 30),
    toptextcolor = Color3.fromRGB(204,153,255),
    topheight = 48,
...
function library:Window(name, hidebutton)
    local window = { }
    ...
    function window:Tab(name)
        ...
        function tab:Sector(name,side)
            ...
            function sector:Button(text, callback)
                local button = { }
                button.text = text or ""
            ...
            function sector:Toggle(text, default, callback, flag)
                local toggle = { }
                toggle.text = text or ""
                ...
                function toggle:Bind(default, flag)
                    local keybind = { }
                ...
                function toggle:Dropdown(items, default, multichoice, callback, flag)
                    local dropdown = { }
                ...
                function toggle:Textbox(default, callback, flag)
                    local textbox = { }
                ...
                function toggle:Colorpicker(default, callback, flag)
                    local colorpicker = { }
                ...
                function toggle:Slider(min, default, max, decimals, callback, flag)
                    local slider = { }
                    slider.text = text or ""
            ...
            function sector:Textbox(text, default, callback, flag)
                local textbox = { }
            ...
            function sector:Slider(text, min, default, max, decimals, callback, flag)
                local slider = { }
                slider.text = text or ""
                slider.callback = callback or function(value) end
                slider.min = min or 0
            ...
            function sector:Colorpicker(text, default, callback, flag)
                local colorpicker = { }
                ...
                function colorpicker:Dropdown(items, default, multichoice, callback, flag)
                    local dropdown = { }
            ...
            function sector:Bind(text,default,newkeycallback,callback,flag)
                local keybind = { }
            ...
            function sector:Dropdown(text, items, default, multichoice, callback, flag)
                local dropdown = { }
            ...
            function sector:Seperator(text)
                local seperator = { }
        ...
        function tab:CreatePlayerlist(name)
			...
			function tab:CreateConfigSystem(side)
				...
				configSystem.sector = tab:Sector("Configs", side or "left")
				local ConfigName = configSystem.sector:Textbox("Config Name", "", ConfigName, function()
				end, "")
				local default = tostring(listfiles(configSystem.configFolder)[1] or ""):gsub(configSystem.configFolder .. "\\", ""):gsub(".txt", "")
				local Config = configSystem.sector:Dropdown("Configs", {}, default, false, function()
				end, "")
				...
				configSystem.Create = configSystem.sector:Button("Create", function()
					for i, v in pairs(listfiles(configSystem.configFolder)) do
				...
				configSystem.Save = configSystem.sector:Button("Save", function()
					local config = {}
				...
				configSystem.Load = configSystem.sector:Button("Load", function()
				...
				configSystem.Delete = configSystem.sector:Button("Delete", function()
					for i, v in pairs(listfiles(configSystem.configFolder)) do
						Config:Remove(tostring(v):gsub(configSystem.configFolder .. "\\", ""):gsub(".txt", ""))
					end
